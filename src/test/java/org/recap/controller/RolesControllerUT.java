...
public class RolesControllerUT extends BaseTestCase {
    ...
    public void deleteRole() throws Exception{
        ...
        ModelAndView modelAndView = rolesController.deleteRole(rolesForm.getRoleId(),rolesForm.getRoleName(),rolesForm.getRoleDescription(),rolesForm.getPermissionNames());
        assertNotNull(modelAndView);
        assertEquals("roles",modelAndView.getViewName());
    }

...
public class ReCAPExceptionTranslationFilter extends GenericFilterBean {
    ...
    private ThrowableAnalyzer throwableAnalyzer = new ReCAPExceptionTranslationFilter.DefaultThrowableAnalyzer();
     ...
     */
    public ReCAPExceptionTranslationFilter() {
    }
    ...
    public ReCAPExceptionTranslationFilter(AuthenticationEntryPoint authenticationEntryPoint, RequestCache requestCache) {
    ...
    protected void sendStartAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        String institution = HelperUtil.getParamSingleValueFromRequest(request, "institution");
    ...
    public ServiceProperties serviceProperties() {
        ...
        sp.setService("http://localhost:9091/search");

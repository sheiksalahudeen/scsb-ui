...
public class ReportsUtil {
    ...
    public void populatePartnersCountForRequest(ReportsForm reportsForm, Date requestFromDate, Date requestToDate) {
        ...
        reportsForm.setPhysicalPrivatePulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.PUL_INST_ID), Arrays.asList(RecapConstants.CGD_PRIVATE),Arrays.asList(RecapConstants.CUL_INST_ID,RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setPhysicalPrivateCulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.CGD_PRIVATE), Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.NYPL_INST_ID),Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setPhysicalPrivateNyplCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.CGD_PRIVATE),Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.CUL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));

        //pul,cul and nypl shared and open physical request counts -- to self
        reportsForm.setPhysicalSharedPulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.PUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN), Arrays.asList(RecapConstants.CUL_INST_ID,RecapConstants.NYPL_INST_ID),Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setPhysicalSharedCulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN), Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.NYPL_INST_ID),Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setPhysicalSharedNyplCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN),Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.CUL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));

        //pul,cul and nypl shared and open physical request counts -- cross partner
        reportsForm.setPhysicalPartnerSharedPulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate,Arrays.asList(RecapConstants.PUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN),Arrays.asList(RecapConstants.PUL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setPhysicalPartnerSharedCulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN), Arrays.asList(RecapConstants.CUL_INST_ID),Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setPhysicalPartnerSharedNyplCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN),Arrays.asList(RecapConstants.NYPL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));

        //pul,cul and nypl private edd request counts
        reportsForm.setEddPrivatePulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.PUL_INST_ID), Arrays.asList(RecapConstants.CGD_PRIVATE), Arrays.asList(RecapConstants.CUL_INST_ID,RecapConstants.NYPL_INST_ID),Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddPrivateCulCount( requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.CGD_PRIVATE),Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddPrivateNyplCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.NYPL_INST_ID),Arrays.asList(RecapConstants.CGD_PRIVATE),Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));

        //pul,cul and nypl shared and open edd request counts -- to self
        reportsForm.setEddSharedOpenPulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.PUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN),Arrays.asList(RecapConstants.CUL_INST_ID,RecapConstants.NYPL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddSharedOpenCulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN),Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.NYPL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddSharedOpenNyplCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN),Arrays.asList(RecapConstants.PUL_INST_ID,RecapConstants.CUL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));

        //pul,cul and nypl shared and open for partners edd request counts-- cross partner
        reportsForm.setEddPartnerSharedOpenPulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.PUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN), Arrays.asList(RecapConstants.PUL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddPartnerSharedOpenCulCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.CUL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN), Arrays.asList(RecapConstants.CUL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddPartnerSharedOpenNyplCount(requestItemDetailsRepository.getPhysicalAndEDDCounts(requestFromDate, requestToDate, Arrays.asList(RecapConstants.NYPL_INST_ID), Arrays.asList(RecapConstants.CGD_SHARED, RecapConstants.CGD_OPEN), Arrays.asList(RecapConstants.NYPL_INST_ID) ,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
    ...
    public void populateRequestTypeInformation(ReportsForm reportsForm, Date requestFromDate, Date requestToDate) {
        ...
        reportsForm.setRetrievalRequestPulCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.PUL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setRetrievalRequestCulCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.CUL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));
        reportsForm.setRetrievalRequestNyplCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.NYPL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_RETRIEVAL_ORDER_PLACED,RecapConstants.REQUEST_STATUS_INITIAL_LOAD)));

        //pul,cul and nypl Recall request counts
        reportsForm.setRecallRequestPulCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.PUL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_RECALLED)));
        reportsForm.setRecallRequestCulCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.CUL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_RECALLED)));
        reportsForm.setRecallRequestNyplCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.NYPL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_RECALLED)));

        //pul,cul and nypl Edd request counts
        reportsForm.setEddRequestPulCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.PUL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddRequestCulCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.CUL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
        reportsForm.setEddRequestNyplCount(requestItemDetailsRepository.getEDDRecallRetrievalRequestCounts(requestFromDate, requestToDate,RecapConstants.NYPL_INST_ID,Arrays.asList(RecapConstants.REQUEST_STATUS_EDD)));
